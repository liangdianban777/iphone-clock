...
import { formatDurationDigital, formatDurationText, getFinishTime, getRemainingMs } from '@/util';
...
const ActiveItem = ({timer}: { timer: ActiveTimer }) => {
    ...
    return (
        <TimerListItemRow
            ...
            secondaryText={timer.label === '' ? formatDurationText(timer.total) : timer.label}
